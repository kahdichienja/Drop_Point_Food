...
import 'package:foodbyte/screens/add_ratings_screen.dart';
import 'package:foodbyte/screens/menu_photos_screen.dart';
import 'package:foodbyte/screens/review_rating_screen.dart';
import 'package:foodbyte/values/data.dart';
import 'package:foodbyte/values/values.dart';
import 'package:foodbyte/widgets/card_tags.dart';
import 'package:foodbyte/widgets/dark_overlay.dart';
import 'package:foodbyte/widgets/heading_row.dart';
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          HeadingRow(
                            ...
                            onTapOfNumber: () => Get.to(MenuPhotosScreen()),
                          ),
                          SizedBox(height: 16.0),
                          Container(
                            height: 120,
                          ...
                          HeadingRow(
                            ...
                            number: StringConst.SEE_ALL_32,
                            onTapOfNumber: () =>Get.to(ReviewRatingScreen()),
                          ),
                          SizedBox(height: 16.0),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
